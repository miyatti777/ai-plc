...
safe_copy_if_missing "$SCRIPT_DIR/templates/wiki/wiki.md" "$TARGET_DIR/.claude/wiki/wiki.md"
...
echo "  2. Memory: project knowledge lives in .claude/wiki/ (curate as you go)."
echo "     User model/preferences use Claude Code's native memory (auto-managed) — no user.md needed."
echo "  3. ⚠️  Reload VS Code window (Cmd+Shift+P → 'Developer: Reload Window')"
echo "     to make slash commands visible"
echo "  4. Run: /01-collection to start your first pipeline"
echo ""
